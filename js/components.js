...
(function () {
  ...
  (function () {
    ...
    var metas = [
      [
        "keywords",
        "photography, automotive photography, portrait photography, travel photography, Nev, nevwithahoodie, Pordenone, Friuli, Venezia Giulia, Italia, fotografia auto, fotografia ritratto, Porsche 911, Mustang, Mazda MX5, Ford, Toyota Celica, Molveno, Verona, Cansiglio, India, Castello di Miramare, Trieste, fotografia paesaggio",
      ],
  ...
  const PARENT_MAP = {
    ...
    porsche911: "masterpieces",
  };
  const activePage = PARENT_MAP[page] || page;

  /* ── SVGs ── */
  const IG_BIG =
    '<svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="2" y="2" width="20" height="20" rx="5"/><circle cx="12" cy="12" r="4"/><circle cx="17.5" cy="6.5" r=".5" fill="currentColor"/></svg>';
  const IG_SM =
    '<svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="2" y="2" width="20" height="20" rx="5"/><circle cx="12" cy="12" r="4"/><circle cx="17.5" cy="6.5" r=".5" fill="currentColor"/></svg>';
  const MAIL_SM =
  ...
  const navLinks = NAV_LINKS.map(function (l) {
    return mkLink(l);
  }).join("\n      ");
  ...
  if (navMount) {
    navMount.outerHTML =
      ...
      '<a class="logo" href="' +
      P +
      'index.html" translate="no">NEV<span>.</span></a>' +
      '<div class="nav-links">' +
      navLinks +
      "\n      " +
      navAbout +
  ...
  if (footMount) {
    ...
    footMount.outerHTML =
      ...
      '<a href="https://www.instagram.com/nev.shotz/" target="_blank" rel="noopener" class="ft-soc-btn ig" title="@nev.shotz">' +
      IG_BIG +
      "</a>" +
      "</div>" +
      "</div>" +
      ...
      MAIL_SM +
      " navpreet.singh1209@gmail.com</a>" +
      '<a class="ft-link" href="https://www.instagram.com/nev.shotz/" target="_blank" rel="noopener">' +
      IG_SM +
      " @nev.shotz</a>" +
      '<a class="ft-link" href="' +
      P +
      'privacy.html" style="margin-top:6px;font-size:11px;opacity:.7">Privacy Policy</a>' +
      "</div>" +
      "</div>" +
      '<div class="ft-bottom">' +
      ...
      '<div class="ft-copy"><a href="' +
      P +
      'privacy.html" style="color:inherit;opacity:.6">Privacy &amp; Cookies</a></div>' +
      "</div>" +
      "</footer>";
  }
